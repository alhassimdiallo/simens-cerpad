...
class BiochimiePaillasse
{
	...
	public function setListeBiochimie($listeBiochimie){
		$this->_listeBiochimie = $listeBiochimie;
	}
	...
	public function getStyle6(){
 	...
 	protected  function getNoteInformations(){
 		...
 		$listeBiochimie = $this->_listeBiochimie;
 		
 		$indice = 1;
 		for($i = 0 ; $i < count($listeBiochimie) ; $i++){
 			...
 			$idpatient = $listeBiochimie[$i][0];
 			$nom = $listeBiochimie[$i][1];
 			$prenom = $listeBiochimie[$i][2];
 			$listeAnalyses = $listeBiochimie[$i][3];
 			$conformite = $listeBiochimie[$i][4];
