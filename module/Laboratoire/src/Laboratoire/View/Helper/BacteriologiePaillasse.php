...
class BacteriologiePaillasse
{
	...
	public function setEnTete(){
		...
		$this->_page->drawText('BACTERIOLOGIE',
	...
	public function setListeBacteriologie($listeBacteriologie){
		$this->_listeBacteriologie = $listeBacteriologie;
	}
	...
	public function getStyle6(){
 	...
 	protected  function getNoteInformations(){
 		...
 		$listeBacteriologie = $this->_listeBacteriologie;
 		
 		$indice = 1;
 		for($i = 0 ; $i < count($listeBacteriologie) ; $i++){
 			...
 			$idpatient = $listeBacteriologie[$i][0];
 			$nom = $listeBacteriologie[$i][1];
 			$prenom = $listeBacteriologie[$i][2];
 			$listeAnalyses = $listeBacteriologie[$i][3];
 			$conformite = $listeBacteriologie[$i][4];
