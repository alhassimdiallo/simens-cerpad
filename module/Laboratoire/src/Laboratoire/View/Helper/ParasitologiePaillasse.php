...
class ParasitologiePaillasse
{
	...
	public function setListeParasitologie($listeParasitologie){
		$this->_listeParasitologie = $listeParasitologie;
	}
	...
	public function getStyle6(){
 	...
 	protected  function getNoteInformations(){
 		...
 		$listeParasitologie = $this->_listeParasitologie;
 		
 		$indice = 1;
 		for($i = 0 ; $i < count($listeParasitologie) ; $i++){
 			...
 			$idpatient = $listeParasitologie[$i][0];
 			$nom = $listeParasitologie[$i][1];
 			$prenom = $listeParasitologie[$i][2];
 			$listeAnalyses = $listeParasitologie[$i][3];
 			$conformite = $listeParasitologie[$i][4];
