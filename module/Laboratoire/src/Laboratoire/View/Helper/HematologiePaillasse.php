	...
	public function getStyle6(){
 	...
 	protected  function getNoteInformations(){
 		...
 		for($i = 0 ; $i < count($listeHematologie) ; $i++){
 			...
 			$idpatient = $listeHematologie[$i][0];
 			$nom = $listeHematologie[$i][1];
 			$prenom = $listeHematologie[$i][2];
 			$listeAnalyses = $listeHematologie[$i][3];
 			$conformite = $listeHematologie[$i][4];
