...
/*****************************************************************************************************************************/
	...
	*/
	...
	public function getInfosAlertVcm($idDemande, $idAnalyse)
	{
		...
		if($idAnalyse == 71){ //NFS&TR
			...
			if(strstr($infosResultat, 'anÃ©mie') || strstr($infosResultat, 'AnÃ©mie')){
				$resultatFinal = array(71, 'AnÃ©mie', 'en_cours--hypo--globule_rouge', $infosResultat, $idDemande);
			}
		...
		}elseif ($idAnalyse == 25){ //CHOLESTEROL TOTAL (Lipidémie)
			...
			if($resultat['cholesterol_total_1'] > 2.6){ 
				$resultatFinal = array(25, "Risque d'hyperlipidÃ©mie", 'risque--hyper--lipidemie', $infosResultat, $idDemande);
			}elseif($resultat['cholesterol_total_1'] > 2.2){
				$resultatFinal = array(25, "Risque de trouble de la lipidÃ©mie", 'risque--patho--lipidemie', $infosResultat, $idDemande);
			}
			...
			if($resultatTgoAsat['tgo_asat'] > 35){
				$resultatFinal = array(37, "Maladie hÃ©patique", 'en_cours--patho--foie', $infosResultat, $idDemande);
			}
		}elseif ($idAnalyse == 21){ //GLYCEMIE 
			$resultat = $this->getResultatDemandeAnalyseTable()->getValeursGlycemie($idDemande);
			$infosResultat =  'GlycÃ©mie : '.$resultat['glycemie_1'].' g/l &nbsp; soit &nbsp; '.$resultat['glycemie_2'].' mmol/l';
				
			if($resultat['glycemie_1'] < 0.6){ ///coords : 130, 49, 151, 80
				$resultatFinal = array(21, "HypoglycÃ©mie", 'en_cours--hypo--glycemie', $infosResultat, $idDemande);
			}elseif($resultat['glycemie_1'] > 1.10){ 
				$resultatFinal = array(21, "HyperglycÃ©mie", 'en_cours--hyper--glycemie', $infosResultat, $idDemande);
			}
		}elseif ($idAnalyse == 22){ //CREATININEMIE 
			$resultat = $this->getResultatDemandeAnalyseTable()->getValeursCreatininemie($idDemande);
			$infosResultat =  'CrÃ©atininÃ©mie : '.$resultat['creatininemie'].' mg/l';
				
			if($resultat['creatininemie'] > 13){ ///coords : 60, 110, 81, 141
				$resultatFinal = array(22, "Insuffisance rÃ©nale", 'en_cours--hypo--rein', $infosResultat, $idDemande);
			}
			...
			$infosResultat =  'En Ã©tat de grossesse';
	...
	protected function getResultatsPV($iddemande){
	    ...
	    if($resultat){
	        ...
	        $html .= ($resultat['identification_rdm_positive_choix2'])   ? '<script> $("#identification_rdm_positive_Choix2_pv").trigger("click").attr("disabled",true); </script>' : '<script>$("#identification_rdm_positive_Choix2_pv").attr("disabled",true); </script>';
	        
	        $html .= ($resultat['autre_flore_cocci_pos_Choix1'])   ? '<script> $("#autre_flore_cocci_pos_Choix1_pv").trigger("click").attr("disabled",true); </script>' : '<script> $("#autre_flore_cocci_pos_Choix1_pv").attr("disabled",true); </script>';
	        $html .= ($resultat['autre_flore_cocci_pos_Choix2'])   ? '<script> $("#autre_flore_cocci_pos_Choix2_pv").trigger("click").attr("disabled",true); </script>' : '<script> $("#autre_flore_cocci_pos_Choix2_pv").attr("disabled",true); </script>';
	...
	protected function getResultatsECBU($iddemande){
		...
		if($resultat){
			...
			"<script>
	            ...
	            $('#type_materiel_ecbu').val('".str_replace( "'", "\'", $resultat['type_materiel'])."');
   	            ...
   	            $('#leucocytes_ecbu').val('".$resultat['Leucocytes']."');
   	           	...
   	           	$('#levures_ecbu').val('".$resultat['Levures']."').trigger('change').attr('disabled', true); 
   	           	$('#filaments_myceliens_ecbu').val('".$resultat['FilamentsMyceliens']."').attr('disabled', true); 
         		$('#cellules_epitheliales_ecbu').val('".$resultat['CellulesEpitheliales']."').attr('disabled', true);
   	           	$('#cellules_epitheliales_champ_ecbu').val('".$resultat['CellulesEpithelialesChamp']."').attr('disabled', true);
         		/*-Flore-*/
			...
			$html .= ($resultat['CulturePos1']) ? '<script> setTimeout(function(){ $("#identification_culture_select_ecbu").val("'.$resultat['IdentificationCulture'].'").attr("disabled", true).trigger("change"); },500); </script>' : '';
	
			/*Parasites --- Parasites --- Parasites*/
			$html .= '<script> setTimeout(function(){ $("#parasites_ecbu").val("'.$resultat['Parasites'].'").attr("disabled", true); },500); </script>';
		...
		if($resultat['IdentificationCulture'] != 0){
			...
			if($resultatAntiBioGramme){
				 ...
				 * BLOCAGE DE TOUS LES CHAMPS
				*/
				$html .='$(".blocChampAntiBioGrammeDuECBUABG input, .blocChampAntiBioGrammeDuECBUABG select").attr("disabled", true)';
				/*
				 * ==============
				*/
	...
	public function enregistrerResultatAction()
	{
	    ...
	    if($idanalyse == 1){
	    	...
	    	if($idanalyse == 66){
	    		$this->getResultatDemandeAnalyseTable()->updateValeursCommentaireECBU($tab, $iddemande);
	    }
		    ...
		    if($idanalyse == 74){
		    	$this->getResultatDemandeAnalyseTable()->updateValeursCommentairePV($tab, $iddemande, 74);
		    }
	...
	public function pv_65($idanalyse=null){
	    ...
	    $html .= "  <td style='width: 18%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='leucocytes_champ_pv' style='width: 100px;' disabled>
	                        <option> </option>
	    ...
	    $html .= "  <td style='width: 17%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <input type='text' id='leucocytes_champ_valeur_pv' style='width: 45px; padding-left: 2px; height: 20px;' disabled>/champs
	                    </label>
	                </td>";
	    $html .= "  <td style='width: 11%;'><label class='lab1' style='font-weight: bold; text-align: right; padding-top: 5px;'> H&eacute;maties </label></td>";
	    $html .= "  <td style='width: 18%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='hematies_champ_pv' style='width: 100px;' disabled>
	                        <option> </option>
	                        <option value=1 >Pr&eacute;sentes</option>
	                        <option value=2 >Absentes</option>
	                      </select>
	    ...
	    $html .= "  <td style='width: 16%;'>
	                    <label class='lab2' style='padding-top: 5px; width: 73%;' title='champs'>
	                      <input type='text' id='hematies_champ_valeur_pv' style='width: 45px; padding-left: 2px; height: 20px;'  disabled>/c.
	                    </label>
	                </td>";
	    $html .= "</tr>";
	    $html .= "</table>";
	    ...
	    $html .= "  <td style='width: 18%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='cellules_epitheliales_champ_pv' style='width: 100px;' disabled>
	                        <option> </option>
	                        <option value=1 >Pr&eacute;sentes</option>
	                        <option value=2 >Absentes</option>
	                      </select>
	    ...
	    $html .= "  <td style='width: 17%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <input type='text' id='cellules_epitheliales_champ_valeur_pv' style='width: 45px; padding-left: 2px; height: 20px;' disabled>/champs
	                    </label>
	                </td>";
	    ...
	    $html .= "  <td style='width: 30%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='levures_pv' style='width: 120px;' disabled>
	                        <option> </option>
	                        <option value=1 >Pr&eacute;sence</option>
	                        <option value=2 >Absence</option>
	                      </select>
	    ...
	    $html .= "  <td style='width: 25%;'>
	                    <label class='lab2' style='padding-top: 5px; width: 83%;'>
	                      <select id='filaments_myceliens_pv' style='width: 120px;' disabled>
	                        <option> </option>
	                        <option value=1 >Pr&eacute;sence</option>
	                        <option value=2 >Absence</option>
	                      </select>
	    ...
	    $html .= "  <td style='width: 53%;'>
	                    <label class='lab2' style='padding-top: 5px; width: 92%;'>
	                      <span style='font-weight: bold; font-size: 20px; text-align: left; visibility: hidden;' class='flore_note_class_pv'> &#10145;
	                        <input type='text' id='flore_note_pv' style='width: 260px; text-align: left; font-size: 16px; padding-left: 2px;' disabled>
	                      </span>
	                    </label>
	                </td>";
	    $html .= "</tr>";
	    ...
	    $html .= "  <td style='width: 38%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='autre_flore_pv' style='width: 220px; font-size: 13px;'  onchange='getAutreFloreCocciPositif(this.value)' disabled>
	                        <option> </option>
	    ...
	    if($idanalyse == 74){
	    	...
	    	*/
	    	$html .= "<table style='width: 100%;'>";
	    	$html .= "<tr class='ligneAnanlyse' style='width: 100%;'>";
	    	$html .= '  <td style="width: 25%;"><label class="lab1" style="padding-top: 5px;"><span style="font-weight: bold;" title="Recherche d\'Ag de Chlamydia trachomatis"> Rech. d\'Ag Chlam. </span></label></td>';
	    	$html .= "  <td style='width: 25%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	...
	public function ecbu_66(){
		...
		*/
		$html .= "<table style='width: 100%;'>";
		$html .= "<tr class='ligneAnanlyse' style='width: 100%;'>";
		$html .= "  <td style='width: 20%;'><label class='lab1' style='padding-top: 5px;'><span style='font-weight: bold;' > Parasites </span></label></td>";
		$html .= "  <td style='width: 35%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='parasites_ecbu' style='width: 220px;' readonly>
	                        <option> </option>
	                      </select>
	                    </label>
	                </td>";
		...
		*/
		...
		$html .= "  <td style='width: 27%;'>
	                    <label class='lab2' style='padding-top: 5px;'>
	                      <select id='identification_culture_select_ecbu' style='width: 190px;' onchange='getIconeAntibiogrammeCulturePosECBU(this.value,1)' readonly>
	                      </select>
	                    </label>
	                </td>";
	...
	public function getAntiBioGrammeDeECBU()
	{
		...
		*/
		 ...
		 * Ampicilline AM
		*/
		$html .= '<table style="width: 100%;" class="designEnTeteAnalyse  blocChampAntiBioGrammeDuECBUABG">';
		$html .= '<tr class="ligneAnanlyse" style="width: 100%;">';
		$html .= '  <td style="width: 62%;"><label class="lab1 labABGRadius" style="padding-top: 5px;"><span style="font-weight: bold;" > Ampicilline AM </span></label></td>';
		 ...
		 * Amoxilline AMX
		*/
		$html .= '<table style="width: 100%; margin-top: -1px;" class="designEnTeteAnalyse  blocChampAntiBioGrammeDuECBUABG">';
		$html .= '<tr class="ligneAnanlyse" style="width: 100%;">';
		$html .= '  <td style="width: 62%;"><label class="lab1 labABGRadius" style="padding-top: 5px;"><span style="font-weight: bold;" > Amoxilline AMX </span></label></td>';
		...
		*/
		...
		$html .= '<table style="width: 100%; margin-top: 15px;" class="designEnTeteAnalyse  blocChampAntiBioGrammeDuECBUABG">';
		$html .= '<tr class="ligneAnanlyse" style="width: 100%;">';
		if($this->layout()->user['role'] == 'biologiste' || $this->layout()->user['role'] == 'technicien'){
	...
	*/
	...
	public function impressionResultatsAnalysesDemandeesAction()
	{
		...
		$listeParasites = array();
		$resultatsAntiBioGrammeDuECBU = array();
		...
		for($j = 0 , $i = 0 ; $i < count($listeResultats) ; $i++ ){
			...
			//PV --- PV --- PV --- PV
			elseif($idanalyse == 65 || $idanalyse == 74){ //PV
			    $analysesDemandees  [$j++] = $listeResultats[$i];
			...
			elseif($idanalyse == 66){ //ECBU
				...
				$listeParasites = $this->getResultatDemandeAnalyseTable()->getListeParasitesIdLibelleASC();
				$resultatsAntiBioGrammeDuECBU = $this->getResultatDemandeAnalyseTable()->getValeursAntiBioGrammeECBU($iddemande);
			}
			//=========================================================
			//=========================================================
		...
		if($analysesSerologieECBU){
			...
			$pdf->setListeParasites($listeParasites);
			$pdf->setResultatsAntiBioGrammeECBUDemande($resultatsAntiBioGrammeDuECBU);
