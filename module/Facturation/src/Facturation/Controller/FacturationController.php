...
class FacturationController extends AbstractActionController {
	...
	public function enregistrerAdmissionAction() {
	    ...
	    /*
	     * VÈrifier estce qu'un autre utilisateur n'est pas entrain de vouloir enregistrer
	     * la facture si oui on teste si les demandes ne sont pas dÈj‡ facturÈes
	     **/
	...
	public function creerCodePrelevementAction($idfacturation) {
		...
		//Verifier si les analyses 72 ou 73 sont selectionnÈes
