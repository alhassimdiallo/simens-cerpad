...
class AnalysesDemandeesPdf
{
	...
	protected $_listeAnalysesDemandees;
	...
	public function setListeAnalysesDemandees($listeAnalysesDemandees){
		$this->_listeAnalysesDemandees = $listeAnalysesDemandees;
	}
	...
	protected  function getNoteInformations(){
		...
		$listeAnalysesDemandees = $this->_listeAnalysesDemandees;
		
		$i = 1;
		foreach ($listeAnalysesDemandees as $listeAnalyses){
			$analyses[$i] = $listeAnalyses['Designation'];
			$typesAnalyses[$i] = $listeAnalyses['Libelle'];
			$tarifs[$i++] = $listeAnalyses['Tarif'];
		}
